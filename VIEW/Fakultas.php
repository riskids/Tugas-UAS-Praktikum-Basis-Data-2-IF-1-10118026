...
<nav class="navbar navbar-expand-lg  navbar-light bg-primary fixed-top">
  ...
  <div class="container">
    <h2 class="text-center m-3">Data Fakultas</h2>
    <a class="btn btn-warning" href="../index.php" role="button">Kembali</a>
    <form class="form-inline" method="GET" action="CRUD/fakultas_cari.php">
      ...
      <a class="btn btn-primary m-3" href="CRUD/fakultas_tambah.php" role="button">Tambah Data</a>
    </form>
    <!-- INCLUDE -->
    <?php    
    $db = dbConnect();
          ...
          ?>
            ...
            <tbody>
              <tr>
                ...
                <td>
                <a class="btn btn-danger" href="CRUD/fakultas_hapus.php?IdFakultas=<?php echo $barisdata["id_fakultas"];?>" role="button">Hapus</a>
                  <a class="btn btn-success" href="CRUD/fakultas_ubah.php?IdFakultas=<?php echo $barisdata["id_fakultas"];?>" role="button">Ubah</a>
                </td>
                <!-- INCLUDE -->
              <?php
            }
