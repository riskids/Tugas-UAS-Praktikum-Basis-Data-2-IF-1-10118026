...
<nav class="navbar navbar-expand-lg  navbar-light bg-primary fixed-top">
  ...
  <div class="container">
    <h2 class="text-center m-3">Data Ruangan</h2>
    <a class="btn btn-warning" href="../index.php" role="button">Kembali</a>
    <form class="form-inline" method="GET" action="CRUD/ruangan_cari.php">
      ...
      <a class="btn btn-primary m-3" href="CRUD/ruangan_tambah.php" role="button">Tambah Data</a>
    </form>
    <!-- INCLUDE -->
    <?php    
    $db = dbConnect();
          ...
          ?>
            ...
            <tbody>
              <tr>
                ...
                <td><?php echo $barisdata["kapasitas"]; ?></td>
                <td>
                <a class="btn btn-danger" href="CRUD/ruangan_hapus.php?NoRuang=<?php echo $barisdata["no_ruangan"];?>" role="button">Hapus</a>
                  <a class="btn btn-success" href="CRUD/ruangan_ubah.php?NoRuang=<?php echo $barisdata["no_ruangan"];?>" role="button">Ubah</a>
                </td>
                <!-- INCLUDE -->
              <?php
            }
