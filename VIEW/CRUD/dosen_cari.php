...
$sql = "SELECT * FROM dosen where nip LIKE '%$cari%'";
$res = $db->query($sql);
...
<nav class="navbar navbar-expand-lg  navbar-light bg-primary fixed-top">
  ...
  <div class="container">
    <h2 class="text-center m-3">Data Cari Dosen</h2>
    <!-- INCLUDE -->
    <!-- END -->
      ...
      ?>
        ...
        <tbody>
          ...
          <td scope="row"><?php echo $barisdata["nip"]; ?></td>
            ...
            <td>
            <a class="btn btn-danger" href="dosen_hapus.php?NIP=<?php echo $barisdata["nip"]; ?>" role="button">Hapus</a>
                  <a class="btn btn-success" href="dosen_ubah.php?NIP=<?php echo $barisdata["nip"]; ?>" role="button">Ubah</a>
            </td>
            <!-- INCLUDE -->
          <?php
        }
