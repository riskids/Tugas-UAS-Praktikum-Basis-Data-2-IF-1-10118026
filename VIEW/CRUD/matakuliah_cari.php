...
$sql = "SELECT * FROM matakuliah where id_matakuliah LIKE '%$cari%'";
$res = $db->query($sql);
...
<head>
  ...
  <title>Data Cari Matakuliah</title>
</head>
...
<nav class="navbar navbar-expand-lg  navbar-light bg-primary fixed-top">
  ...
  <div class="container">
    <h2 class="text-center m-3">Data Cari Matakuliah</h2>
    <!-- INCLUDE -->
    <!-- END -->
    <table class="table table-hover">
      ...
      ?>
        ...
        <tbody>
          ...
          <td>
          <a class="btn btn-danger" href="matakuliah_hapus.php?IdMatkul=<?php echo $barisdata["id_matakuliah"]; ?>" role="button">Hapus</a>
          <a class="btn btn-success" href="matakuliah_ubah.php?IdMatkul=<?php echo $barisdata["id_matakuliah"]; ?>" role="button">Ubah</a>
          </td>
          <!-- INCLUDE -->
        <?php
      }
