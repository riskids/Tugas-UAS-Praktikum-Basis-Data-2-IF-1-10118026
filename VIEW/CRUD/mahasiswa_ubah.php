...
<nav class="navbar navbar-expand-lg  navbar-light bg-primary fixed-top">
    ...
    <div class="container">
        ...
        <h2 class="alert alert-primary text-center mt-5">Ubah Mahasiswa</h2>
        <?php
        if (isset($_GET["NIM"])) {
            $db = dbConnect();
            ...
            if ($dataruang) {
        ?>
                <form action="mahasiswa_simpan_ubah.php" method="post" name="frm">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="NIM" id="NIM" class="form-control" placeholder="masukan NIM " value="<?php echo $dataruang["nim"]; ?>" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="NoTlp" id="NoTlp" class="form-control" placeholder="masukan no telp mahasiswa" value="<?php echo $dataruang["no_tlp"]; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
