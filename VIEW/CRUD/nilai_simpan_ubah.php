...
<nav class="navbar navbar-expand-lg  navbar-light bg-primary fixed-top">
    ...
    <div class="container">
        <h2 class="text-center m-3">Simpan Data Ubah Nilai Berhasil</h2>
        ...
        if ($db->connect_errno == 0) {
            ...
            angka='$Angka',        
            indeks='$Indeks'
            WHERE nim='$NIM' AND id_matakuliah='$IdMatkul'";
            //echo $sql;
            $res = $db->query($sql);
            // var_dump($res);
        ...
        ?>
                <div class="text-center">
                    <a href="../nilai.php"><button class="btn btn-primary">Go</button></a>
                    </div>
                <?php
                } else {
                ?>
