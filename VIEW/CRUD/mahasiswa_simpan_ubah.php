...
<nav class="navbar navbar-expand-lg  navbar-light bg-primary fixed-top">
    ...
    <div class="container">
        <h2 class="text-center m-3">Simpan Data Ubah Mahasiswa Berhasil</h2>
        ...
        if ($db->connect_errno == 0) {
            ...
            $Jurusan   = $db->escape_string($_POST["IdJurusan"]);  


            $sql =   $sql = "UPDATE mahasiswa
            SET 
            nama='$Nama',ttl='$TTL',
            jk='$JK',no_tlp='$NoTlp',
            alamat='$Alamat', id_jurusan='$Jurusan'
            WHERE nim='$NIM'";
            //echo $sql;
            $res = $db->query($sql);
            if ($res) {
