...
<nav class="navbar navbar-expand-lg  navbar-light bg-primary fixed-top">
    ...
    <div class="container">
        ...
        <form action="fakultas_simpan_tambah.php" method="post" name="frm">
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="IdFakultas" id="idfakultas" class="form-control" placeholder="masukan Id Fakultas">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row mt-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="NamaFakultas" id="nama_fakultas" class="form-control" placeholder="masukan Nama Fakultas">
                </div>
            </div>
