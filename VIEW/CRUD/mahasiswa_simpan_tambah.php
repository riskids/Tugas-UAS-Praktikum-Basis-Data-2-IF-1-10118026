...
<nav class="navbar navbar-expand-lg  navbar-light bg-primary fixed-top">
    ...
    <div class="container">
        <h2 class="text-center m-3">Simpan Data Mahasiswa</h2>
        ...
        if ($db->connect_errno == 0) {
            ...
            $sql = "INSERT INTO mahasiswa(nim, nama, ttl, jk, no_tlp, alamat, id_jurusan)
        VALUES ('$NIM','$Nama','$TTL','$JK','$NoTlp','$Alamat','$IdJurusan')";
            //echo $sql;
            $res = $db->query($sql);
            if ($res) {
        ...
        ?>
                <div class="text-center">
                    <a href="../Mahasiswa.php"><button class="btn btn-primary">Go</button></a>
                    </div>
                <?php
                } else {
                ?>
