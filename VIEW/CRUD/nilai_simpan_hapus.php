...
<head>
    ...
    <title>Simpan Hapus Data Nilai</title>
</head>

<body>
    <div class="container">
        <h2 class="text-center m-3">Simpan Hapus Nilai Berhasil</h2>
        ...
        if ($db->connect_errno == 0) {
            ...
            $sql = "DELETE FROM nilai WHERE nim= '$NIM'AND  id_matakuliah= '$IdMatkul'";
            //echo $sql;
            $res = $db->query($sql);
            if ($res) {
