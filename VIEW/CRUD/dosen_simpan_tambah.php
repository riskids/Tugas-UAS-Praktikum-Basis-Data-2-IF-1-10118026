...
<nav class="navbar navbar-expand-lg  navbar-light bg-primary fixed-top">
    ...
    <div class="container">
        <h2 class="text-center m-3">Simpan Data Dosen</h2>
        ...
        if ($db->connect_errno == 0) {
            ...
            $sql = "INSERT INTO dosen(nip, nama, ttl, jk, no_telp, alamat)
        VALUES ('$NIP','$Nama','$TTL','$JK','$NoTelp','$Alamat')";
            //echo $sql;
            $res = $db->query($sql);
            if ($res) {
        ...
        ?>
                <div class="text-center">
                    <a href="../Dosen.php"><button class="btn btn-primary">Go</button></a>
                    </div>
                <?php
                } else {
                ?>
