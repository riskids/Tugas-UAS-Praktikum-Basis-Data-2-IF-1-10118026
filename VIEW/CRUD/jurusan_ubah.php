...
<nav class="navbar navbar-expand-lg  navbar-light bg-primary fixed-top">
    ...
    <div class="container">
        ...
        <h2 class="alert alert-primary text-center mt-5">Ubah Jurusan</h2>
        <?php
        ...
        ?>
                <form action="jurusan_simpan_ubah.php" method="post" name="frm">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="IdJurusan" id="IdJurusan" class="form-control" placeholder="masukan No Jurusan" value="<?php echo $dataruang["id_jurusan"]; ?>" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="IdFakultas" id="IdFakultas" class="form-control">
                                    ...
                                    foreach ($data as $barisdata) {
                                        ...
                                        echo "<option value=\"" . $barisdata["id_fakultas"] . "\" " . ($barisdata["id_fakultas"]==$dataruang["id_fakultas"]?"selected":"") .">". $barisdata["id_fakultas"] . "</option>\n";
                                    }
                                    ?>
                    ...
                    <div class="form-group">
                        <div class="row mt-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="NamaJurusan" id="NamaJurusan" class="form-control" placeholder="masukan NamaJurusan" value="<?php echo $dataruang["nama_jurusan"]; ?>">
                            </div>
                        </div>
